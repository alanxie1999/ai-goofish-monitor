  ...
  tasks: {
    ...
    form: {
      ...
      autoOrder: {
        title: '自动下单',
        enabled: '启用自动下单',
        enabledHint: '当商品价格匹配设定条件时，自动生成下单链接',
        targetPrice: '目标价格',
        targetPricePlaceholder: '例如：5000',
        targetPriceHint: '当商品价格低于或等于此价格时触发下单（留空则使用价格范围）',
        action: '下单操作',
        actionPlaceholder: '选择自动下单操作',
        actions: {
          notifyOnly: '仅通知（不生成链接）',
          generateLink: '生成下单链接',
          autoBuy: '自动购买（实验性）',
        },
        actionHint: '生成下单链接后，通知中会附带可直接跳转到闲鱼订单确认页的链接',
      },
      maxPages: '搜索页数',
      schedule: '定时规则',
      cronPresetTab: '预设',
